---
title: "Vibration Composition Effects API"
slug: "android-vibration-composition-effects"
description: "VibrationEffect.Composition for rich haptics: PRIMITIVE_CLICK, customizable amplitudes, and hardware capability checks."
datePublished: "2026-07-29"
dateModified: "2026-07-29"
tags: ["Android", "Haptics", "API"]
keywords: "VibrationEffect composition, rich haptics Android, haptic primitives API"
faq:
  - q: "When should Android teams adopt vibration composition effects api?"
    a: "Adopt vibration composition effects api when you have production signals — Play Vitals regressions, ANR clusters, user-reported bugs, or security findings — and simpler fixes are exhausted. Pilot on one screen or user segment before platform-wide rollout, and measure cold start, jank, and crash rates before and after."
  - q: "What are the most common mistakes with vibration composition effects api?"
  ...
  - q: "How do I debug vibration composition effects api issues in production?"
...
object AndroidVibrationCompositionEffectsFeature {
    fun enabled(): Boolean =
        RemoteConfig.getBoolean("android-vibration-composition-effects_enabled", default = false)
}
...
class AndroidRepository @Inject constructor(
    ...
    suspend fun execute(): Result<Unit> = withContext(dispatcher) {
        runCatching {
            // Core logic for vibration composition effects api
        }
    }
}
```
...
Validate on API 26 and API 34+ hardware. Emulator-only testing misses `android-vibration-composition-effects` failures tied to exact alarm permission, photo picker backport behavior, and manufacturer-specific background limits.
...
Teams get vibration composition effects api wrong in predictable ways:
...
When vibration composition effects api misbehaves in production:
...
Before enabling `android-vibration-composition-effects` for all users:
