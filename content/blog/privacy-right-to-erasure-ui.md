---
title: "Right to Erasure UI Flows"
...
export async function Page() {
  const enabled = await flags.isEnabled("privacy_right_to_erasure_ui");
...
Teams get right to erasure ui flows wrong in predictable ways:
...
When right to erasure ui flows misbehaves in production, work top-down:
