...
description: "Rotate OAuth refresh tokens on every exchange and detect reuse—the standard defense when an agent dashboard credential leaks but you cannot revoke every active session instantly for teams running LLM features in production."
