---
title: "Consent Mode for Analytics Integration"
...
export async function Page() {
  const enabled = await flags.isEnabled("privacy_consent_mode_analytics");
...
Teams get consent mode for analytics integration wrong in predictable ways:
...
When consent mode for analytics integration misbehaves in production, work top-down:
