---
title: "Privacy by Design in Frontend Architecture"
...
export async function Page() {
  const enabled = await flags.isEnabled("privacy_privacy_by_design_frontend");
...
Teams get privacy by design in frontend architecture wrong in predictable ways:
...
When privacy by design in frontend architecture misbehaves in production, work top-down:
