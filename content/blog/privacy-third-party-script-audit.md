---
title: "Third-Party Script Privacy Audit"
...
export async function Page() {
  const enabled = await flags.isEnabled("privacy_third_party_script_audit");
...
Teams get third-party script privacy audit wrong in predictable ways:
...
When third-party script privacy audit misbehaves in production, work top-down:
