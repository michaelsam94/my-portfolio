...
When operating **Next.js metadata dynamic og images** (`nextjs-metadata-dynamic-og-images`), tie this section to a measurable SLI—latency, error rate, freshness, or throughput—and review it in weekly ops until the pattern is boringly stable.
