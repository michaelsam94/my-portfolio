...
faq:
  - q: "What breaks first with nextjs turbopack production migration?"
    a: "Misconfigured defaults under load—missing observability, idempotency, or rollback paths."
  - q: "How to test nextjs turbopack production migration?"
    a: "Integration tests on production-like topology and load at 2× peak."
  - q: "When defer nextjs turbopack production migration?"
...
When operating **Next.js turbopack production migration** (`nextjs-turbopack-production-migration`), tie this section to a measurable SLI—latency, error rate, freshness, or throughput—and review it in weekly ops until the pattern is boringly stable.
