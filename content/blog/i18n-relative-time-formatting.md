---
title: "Relative Time Formatting Across Locales"
slug: "i18n-relative-time-formatting"
description: "2 hours ago differs by locale — Intl.RelativeTimeFormat, update intervals, and SSR hydration consistency."
datePublished: "2026-09-13"
dateModified: "2026-09-13"
tags: ["i18n", "Date", "Localization"]
keywords: "relative time formatting, Intl RelativeTimeFormat, locale dates"
faq:
  - q: "What is Relative Time Formatting Across Locales?"
    a: "Relative Time Formatting Across Locales is a production pattern for frontend and product engineering teams building performant, accessible web applications. It addresses real constraints around user experience, security, and measurable outcomes — not theoretical best practices disconnected from shipping code."
  - q: "When should teams adopt Relative Time Formatting Across Locales?"
    a: "Adopt Relative Time Formatting Across Locales when you have field data or user research showing pain — slow interactions, accessibility gaps, conversion drop-offs, or security findings — and simpler fixes have been exhausted. Pilot on one route or feature before rolling out platform-wide."
  - q: "What are common mistakes with Relative Time Formatting Across Locales?"
...
Document which metrics you expect to move. If relative time formatting across locales is a performance change, baseline LCP, INP, and CLS in CrUX or your RUM tool for affected routes before merging. If it is an accessibility change, run axe and manual screen reader checks on the critical path — not just the component story.

## Implementation patterns

Start with the smallest change that proves the approach. For relative time formatting across locales, that usually means one route, one component tree, or one middleware rule — not a platform-wide migration.

```tsx
// Example: progressive adoption pattern
// Step 1 — isolate behind a feature flag or route segment
export async function Page() {
  const enabled = await flags.isEnabled("i18n_relative_time_formatting");
...
Teams get relative time formatting across locales wrong in predictable ways:
...
When relative time formatting across locales misbehaves in production, work top-down:
