...
When operating **Next.js route handlers api design** (`nextjs-route-handlers-api-design`), tie this section to a measurable SLI—latency, error rate, freshness, or throughput—and review it in weekly ops until the pattern is boringly stable.
