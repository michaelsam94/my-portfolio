---
title: "Landmark Regions and Semantic Structure"
slug: "accessibility-landmark-regions-semantic"
description: "main, nav, aside, and search landmarks orient screen reader users — audit patterns for SPA layouts."
datePublished: "2026-08-08"
dateModified: "2026-08-08"
tags: ["Accessibility", "HTML", "Screen Readers"]
keywords: "ARIA landmarks, semantic HTML, screen reader navigation"
faq:
  - q: "What is Landmark Regions and Semantic Structure?"
    a: "Landmark Regions and Semantic Structure is a production pattern for frontend and product engineering teams building performant, accessible web applications. It addresses real constraints around user experience, security, and measurable outcomes — not theoretical best practices disconnected from shipping code."
  - q: "When should teams adopt Landmark Regions and Semantic Structure?"
    a: "Adopt Landmark Regions and Semantic Structure when you have field data or user research showing pain — slow interactions, accessibility gaps, conversion drop-offs, or security findings — and simpler fixes have been exhausted. Pilot on one route or feature before rolling out platform-wide."
  - q: "What are common mistakes with Landmark Regions and Semantic Structure?"
...
Document which metrics you expect to move. If landmark regions and semantic structure is a performance change, baseline LCP, INP, and CLS in CrUX or your RUM tool for affected routes before merging. If it is an accessibility change, run axe and manual screen reader checks on the critical path — not just the component story.

## Implementation patterns

Start with the smallest change that proves the approach. For landmark regions and semantic structure, that usually means one route, one component tree, or one middleware rule — not a platform-wide migration.

```tsx
// Example: progressive adoption pattern
// Step 1 — isolate behind a feature flag or route segment
export async function Page() {
  const enabled = await flags.isEnabled("accessibility_landmark_regions_semantic");
...
Teams get landmark regions and semantic structure wrong in predictable ways:
...
When landmark regions and semantic structure misbehaves in production, work top-down:
