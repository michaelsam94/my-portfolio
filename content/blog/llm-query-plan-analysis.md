...
description: "How to read EXPLAIN plans for agent tool queries, catch sequential scans on vector metadata tables, and wire plan telemetry into your observability stack before latency spikes hit users for teams running LLM features in production."
