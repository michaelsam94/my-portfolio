...
description: "Row-level security for AI agent database access — PostgreSQL RLS policies, session context, SQL generation guardrails, and tests that prove tenants cannot leak through agent tool calls."
