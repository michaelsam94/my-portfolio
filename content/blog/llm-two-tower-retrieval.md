...
description: "Train and serve dual-encoder retrieval for agents: query tower vs document tower, hard negatives, ANN index refresh, and hybrid fusion with BM25 in production for teams running LLM features in production."
