...
faq:
  ...
  - q: "How do you prove deletion happened?"
    a: "Append-only deletion ledger: record what identifier was deleted, from which store, job run ID, timestamp, and checksum of affected key set. Periodic reconciliation scans verify no orphaned rows remain past SLA. Provide export to legal/compliance on request."
---
