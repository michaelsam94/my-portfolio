...
Teams get error recovery and retry ui patterns wrong in predictable ways:
...
When error recovery and retry ui patterns misbehaves in production, work top-down:
