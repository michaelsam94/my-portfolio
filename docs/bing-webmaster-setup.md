...
Use this checklist after deploying the latest build to `https://michaelsam94.com`.

1. Add `https://michaelsam94.com` in Bing Webmaster Tools.
...
4. Confirm Bing can fetch the IndexNow key:
   `https://michaelsam94.com/0eb1eb625c28368318e34f58bec177b0.txt`
